...
DATABASES = {
    "default": {
        ...
        'NAME': 'test', # Use the default database of TiDB
        'USER': '${USERNAME}', # 2RZ3WzcNZTCDfFB.root
        'PASSWORD': '${PASSWORD}', # qmSIgdoW2E09ATlO
        'HOST': '${HOST}', # gateway01.us-west-2.prod.aws.tidbcloud.com
        'PORT': '4000'
    }
}
